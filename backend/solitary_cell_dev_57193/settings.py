"""
Django settings for solitary_cell_dev_57193 project.
...
ROOT_URLCONF = 'solitary_cell_dev_57193.urls'
...
WSGI_APPLICATION = 'solitary_cell_dev_57193.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_cell_dev_57193 API",
    "DESCRIPTION": "API documentation for solitary_cell_dev_57193 App",
    "VERSION": "v1",
}
